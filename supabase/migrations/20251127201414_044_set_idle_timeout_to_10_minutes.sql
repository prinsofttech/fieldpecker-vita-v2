/*
  ...
  ## Overview
  This migration sets the idle timeout to 10 minutes.

  ## Changes
  1. Update default idle_timeout_minutes in trigger functions to 10 minutes
  2. Update existing active sessions to 10 minute timeout

  ## Note
  This provides a balanced timeout period for active usage.
*/

-- Update the create_session_on_login function to use 10 minute timeout
...
-- Update the ensure_user_session function to use 10 minute timeout
...
-- Update all existing active sessions to use 10 minute timeout
